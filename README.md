...
Once the game is finished, the message will be displayed on the game screen with either the winner name (X or O) or Draw game.A player can choose between two symbols with his opponent, usual game uses “X” and “O”.
